...
namespace whusa.Entidades
{
    ...
    public class Ent_ttscol100
    {
        ...
        public Ent_ttscol100(string porno, string pitem, string ploca, string pcwar, decimal pqdel, string plogn, string pdate,
                             int pconf, string pcusr, string pcdat, string pmess, int prefcntd, int prefcntu, string pidrecord)
        {
            this.orno = porno;
            this.item = pitem;
            this.loca = ploca;
