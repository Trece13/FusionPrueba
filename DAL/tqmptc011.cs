...
namespace whusa.DAL
{
    public class tqmptc011
    {
        ...
        private static string tabla = owner + ".tqmptc011" + env;
        ...
        public DataTable findRecordByItem(ref string item, ref string strError)
        {
            ...
            {
                strError = "Error to the search sequence [tqmptc011]. Try again or contact your administrator \n ";
