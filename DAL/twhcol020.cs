...
namespace whusa.Interfases
{
    public class twhcol020
    {
        ...
        private static string tabla = owner + ".twhcol020" + env;
        ...
        public int consultarConsecutivoMaximo(ref string strError)
        {
            ...
            {
                strError = "Error to the search sequence [twhcol020]. Try again or contact your administrator \n ";
                log.escribirError(strError + Console.Out.NewLine + ex.Message, stackTrace.GetFrame(1).GetMethod().Name, method.Name, method.ReflectedType.Name);
            }
