...
namespace whusa.DAL
{
    public class ttihra130
    {
        ...
        private static string tabla = owner + ".ttihra130" + env;
        ...
        public DataTable listRecords(ref string strError) 
        {
            ...
            {
                strError = "Error to the search sequence [ttihra130]. Try again or contact your administrator \n ";
