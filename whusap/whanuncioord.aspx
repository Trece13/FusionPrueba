...
<%
	strSQL = "insert into baan.ttccol301" & Session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'Anuncio Orden',0,0)"
...
<form name="frmord" method="post" action="whanuncioord2a.aspx">
<table>
<tr>
<td><IMG SRC = "images/logophoenix_s.jpg" ></td>
<td></td><td><H2>Production Orders by Quantity</H2></td>
</TABLE>
