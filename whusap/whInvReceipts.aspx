...
<%
	strSQL = "insert into baan.ttccol301" & Session("env") & "(t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'Receipts',0,0)"
...
function setFocus()
{
document.getElementById("recep").focus();
}
...
<%
Dim strrecepcion, strlen, strflag, strmsg  
...
<form name="frmord" method="post" action="whInvReceipts2.aspx">
...
<tr> 
     <td class="style2"><b>No. Recepcion:</b></td>
     <td class="style2">
         <input type="text" id="recep" name="recep" size="9" style="width: 131px; height: 23px;" 
             value=<%=strrecepcion%>></td>
</tr>
<tr> 
<td class="errorMsg" colspan="2"><%=strmsg%></td>
</tr> 
    <td colspan="2" align="center">
      <input type="submit" name="btnLogin" value="  Consulta  ">
    </td>
</tr>
</table>
</form>
