<%@ Page Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true" CodeBehind="whInvArticulo.aspx.cs" Inherits="whusap.WebPages.Migration.whInvArticulo" %>
        ...
        <tr>
            <td style="text-align:left;">
                ...
                <b style="font-size: 11px;">
                    <asp:Label runat="server" ID="lblLote" /></b></span>
            </td>
            <td style="width: 250px; padding:5px;">
                <span style="vertical-align: middle;">
                    <asp:TextBox runat="server" ID="txtLote" CssClass="TextBoxBig" ClientIDMode="Static" />
                </span>
            </td>
        </tr>
        <tr>
