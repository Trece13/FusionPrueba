<%@ Page Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true" CodeBehind="whInvAlmArticulo.aspx.cs" Inherits="whusap.WebPages.Migration.whInvAlmArticulo" %>
        ...
        <tr>
            <td style="text-align:left;">
                ...
                <b style="font-size: 11px;">
                    <asp:Label runat="server" ID="lblArticulo" /></b></span>
            </td>
            <td style="width: 250px; padding:5px;">
                <span style="vertical-align: middle;">
                    <asp:TextBox runat="server" ID="txtArticulo" CssClass="TextBoxBig" ClientIDMode="Static" />
                </span>
            </td>
        </tr>
        <tr>
