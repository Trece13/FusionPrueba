...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="center" id="divZona" runat="server" 
        ...
        <div class="rTableCell" style="background-color: #FFF; width:9%; height: 35px; "><span class="style2" 
                style="vertical-align: middle; width:50%; height: 25px;"><b><asp:Label ID="lblZoneCode" runat="server" /></b></span> </div>
        <div class="rTableCell" style="Width:40%; height: 35px;" align="left">
            <asp:TextBox ID="txtZone" runat="server" CausesValidation="True" MaxLength="15" 
                            Width="100%" CssClass="TextBoxBig InputForm" TabIndex="1" 
                ToolTip="Enter Zone code" Height="30px"></asp:TextBox> </div>
        <div class="rTableCell" style="height: 35px;width:10%;" align="left"><asp:Button ID="btnSearchZone" runat="server" Text="Search Zone" CssClass="ButtonsSendSave" 
                         Width="82px" Height="30px" onclick="btnSearchZone_Click" TabIndex="6" /> </div>
        <div class="rTableCell" style="width:20%; height: 35px; padding:10px;" align="left"> <asp:Label ID="lblZone" runat="server" CssClass="style2"></asp:Label></div>
        </div>
        </div>
    ...
    Visible="false">
        <table class="style16">
            <tr>
                <td style="width:10.5%;">
                <span style="vertical-align: middle; width:123%"><b style="font-size:11px"><asp:Label ID="lblId" runat="server" /> </b></span>
                </td>
                <td style="width:40%;">
                <span style="vertical-align:middle" >
             <asp:TextBox ID="txtLabelId" runat="server" CausesValidation="True" MaxLength="15" 
                    Width="72%" CssClass="TextBox" TabIndex="1" 
             ...
             &nbsp;<asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="ButtonsSendSave" 
                ...
                <td class="rTableCellError" height="90%"s>
                <asp:Label ID="Label1" runat="server" CssClass="style2"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width:10.5%;">
                <span style="vertical-align: middle; width:3%"><b style="font-size:11px"><asp:Label ID="lblDescWarehouse" runat="server" />  </b></span>
                </td>
                <td style=" width:40%;">
                <span style="vertical-align:middle" >
             <asp:TextBox ID="txtCwar" runat="server" CausesValidation="True" MaxLength="9" 
                    Width="72%" CssClass="TextBox" TabIndex="2" 
                    ToolTip="Enter warehouse code" Enabled="False"></asp:TextBox>
           </span>
                </td>
                <td class="rTableCellError" height="90%" style="width:100%;">
                <asp:Label ID="lblCwar" runat="server" CssClass="style2"></asp:Label>
                </td>
            </tr>           
            <tr>
                <td style="width:10.5%;">
                <span style="vertical-align: middle; width:3%"><b style="font-size:11px"><asp:Label ID="lblDescItem" runat="server" />  </b></span>
                </td>
                <td style="width:40%;">
                <span style="vertical-align:middle;" >
              <asp:TextBox ID="txtItem" runat="server" CausesValidation="True" MaxLength="18" 
                           Width="72%" CssClass="TextBox" TabIndex="3" 
            ...
            <tr>
                <td style="width:10.5%;">
           <span style="vertical-align: middle; width:134%"><b style="font-size:11px"><asp:Label ID="lblDescLotCode" runat="server" />  </b></span>
                </td>
                <td style="width:40%;">
           <span style="vertical-align:middle;" >
              <asp:TextBox ID="txtLote" runat="server" CausesValidation="True" MaxLength="16" 
                           Width="72%" CssClass="TextBox" TabIndex="4" 
           ...
           <span style="vertical-align:middle" />
            ...
            <tr>
                <td style="width:10.5%;">
           <span style="vertical-align: middle;"><b style="font-size:11px"><asp:Label ID="lblDescQuantity" runat="server" />  </b></span>
                </td>
                <td style="width:40%;">
           <span style="vertical-align:middle;">
              <asp:TextBox ID="txtQuantity" runat="server" CausesValidation="True" MaxLength="15" 
                           Width="72%" CssClass="TextBox" TabIndex="5" 
