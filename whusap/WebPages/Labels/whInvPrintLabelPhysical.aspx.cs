...
namespace whusap.WebPages.Labels
{
    public partial class whInvPrintLabelPhysical : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rutaServ = UrlBaseBarcode + "/Barcode/BarcodeHandler.ashx?data=" + labelId + "&code=Code128&dpi=96";
            ...
            rutaServ = UrlBaseBarcode + "/Barcode/BarcodeHandler.ashx?data=" + loteId + "&code=Code128&dpi=96";
