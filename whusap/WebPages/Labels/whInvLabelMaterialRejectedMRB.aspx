<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="whInvLabelMaterialRejectedMRB.aspx.cs" Inherits="whusap.WebPages.Labels.whInvLabelMaterialRejectedMRB" %>
    ...
    <table align="left" style="width: 5.8in; height: 3.8in" border="1" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="5" class="style4">
              <img runat="server" id="imgLot" hspace="80" vspace="5" style="width: 4in; height: .5in;"/>
        </td>
    </tr> 
    <tr>
        <td colspan="5" class="style4">
