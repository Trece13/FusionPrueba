<%@ Page Title="" Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true" CodeBehind="whInvWrapRegrindValidation.aspx.cs" Inherits="whusap.WebPages.InvMaterial.whInvWrapRegrindValidation" %>
    ...
    <div align="center" id="divTabla" runat="server" style="width: 80%">
                ...
                <td>
                    ...
                    <span class="style2" style="vertical-align: middle;">
                        <b style="font-size: 11px">
                            <asp:Label ID="lblDescRegrind" runat="server" />
                        </b>
                    </span>
                </td>
        ...
        <div style="padding: 1%; height: 20px; vertical-align: middle; width: 70%; text-align: center;" align="center">
            <asp:Label ID="lblResult" runat="server" CssClass="style2" Font-Bold="True" 
                Font-Italic="True" Font-Size="Medium" ForeColor="#009900"></asp:Label>
            <br />
