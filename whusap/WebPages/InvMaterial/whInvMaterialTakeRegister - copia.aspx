...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="center" id="divZona" runat="server" 
        ...
        <div class="rTableCell" style="background-color: #CFD8FA; width:30%; height: 30x; "><span class="style2" 
                style="vertical-align: middle; width:50%; height: 25px;"><b><asp:Label ID="lblZoneCode" runat="server" /></b></span> </div>
        <div class="rTableCell" style="Width:40%; height: 30px;" align="left">
            <asp:TextBox ID="txtZone" runat="server" CausesValidation="True" MaxLength="15" 
                            Width="100%" CssClass="TextBox" TabIndex="1" 
                ToolTip="Enter Zone code" Height="20px"></asp:TextBox> </div>
        <div class="rTableCell" style="height: 30px;width:20%; "><asp:Button ID="btnSearchZone" runat="server" Text="Search Zone" CssClass="ButtonsSendSave" 
                         Width="82px" Height="25px" onclick="btnSearchZone_Click" TabIndex="6" /> </div>
    ...
    Visible="false">
        <table class="style16">
            <tr>
                <td class="style8">
                <span class="style2" style="vertical-align: middle; width:123%"><b style="font-size:11px"><asp:Label ID="lblId" runat="server" /> </b></span>
                </td>
                <td class="style9">
                <span style="vertical-align:middle" >
            ...
            <tr>
                <td class="style8">
                <span class="style2" style="vertical-align: middle; width:3%"><b style="font-size:11px"><asp:Label ID="lblDescWarehouse" runat="server" />  </b></span>
                </td>
                <td class="style9">
                <span style="vertical-align:middle" >
            ...
            <tr>
                <td class="style8">
                <span class="style2" style="vertical-align: middle; width:3%"><b style="font-size:11px"><asp:Label ID="lblDescItem" runat="server" />  </b></span>
                </td>
                <td class="style9">
                <span style="vertical-align:middle;" >
            ...
            <tr>
                <td class="style8">
           <span class="style15" style="vertical-align: middle; width:134%"><b style="font-size:11px"><asp:Label ID="lblDescLotCode" runat="server" />  </b></span>
                </td>
                <td class="style9">
           <span style="vertical-align:middle;" >
           ...
           <span style="vertical-align:middle" />
            ...
            <tr>
                <td class="style8">
           <span class="style2" style="vertical-align: middle;"><b style="font-size:11px"><asp:Label ID="lblDescQuantity" runat="server" />  </b></span>
                </td>
                <td class="style9">
           <span style="vertical-align:middle;">
