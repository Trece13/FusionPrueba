        ...
        <div class="rTable" style="width: 100%; height: 40px;">
            <div class="rTableBody" style="width: 80%; height: 30px;">
                ...
                <div class="rTableCell" style="width: 130px; height: 30px;" align="left">
                    <asp:TextBox ID="txtWorkOrder" runat="server" CausesValidation="True" MaxLength="9" Width="120px" CssClass="TextBox" TabIndex="1" ToolTip="Enter work order number" Height="20px">
                    </asp:TextBox>
                </div>
    ...
    <div style="width: 90%; top: 10px;">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="grdRecords" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                    SkinID="Default" Width="98%" HorizontalAlign="Center">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Confirm" HeaderStyle-CssClass="HeaderColor" ControlStyle-Width="70px"
        ...
        <div id="FooterGrid" style="width: 80%; height: 50px; vertical-align: middle; padding-top: 15px;" runat="server" align="center">
            <span style="text-align: right; vertical-align: middle;">
                <asp:Button ID="btnSave" runat="server" Text="Save Items" CssClass="ButtonsSendSave" Width="90px" Height="20px" OnClick="btnSave_Click" />
            </span>
        </div>
    </div>
