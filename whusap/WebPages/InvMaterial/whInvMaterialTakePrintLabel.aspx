...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="left" style="width:60%; vertical-align:text-top;">
        <table class="style16">
            ...
            <tr>
                <td class="rTableCellHead" style="height:10%; width:30%">
                    <span class="style2" style="vertical-align: middle; width:3%">
                        <b style="font-size:11px">
                            <asp:Label ID="lblDescZone" runat="server" />  
                        </b>
                    </span>
                </td>
                <td class="rTableCellLeft" style="width: 60%; height:18px;">
            ...
            <tr>
                <td class="rTableCellHead" style="height:10%;width:30%">
                    <span class="style2" style="vertical-align: middle; width:100%">
                        <b style="font-size:11px">
            ...
            <tr>
                <td class="rTableCellHead" style="width:30%">
                    <span class="style2" style="vertical-align: middle; width:100%">
                        <b style="font-size:11px">
                            <asp:Label ID="lblDescLotCode" runat="server" />  
                        </b>
                    </span>
                </td>
                <td class="rTableCellLeft" style="width: 60%; height:18px;">
            ...
            <tr>
                <td class="rTableCellHead" style="width:30%">
                    ...
                    <span class="style2" style="vertical-align: middle; width:100%">  
                        <b style="font-size:11px">
                            <asp:Label ID="lblDescQuantity" runat="server" />  
                        </b>
                    </span>
                </td>
                <td class="rTableCellLeft" style="width: 60%; height:18px;">
    ...
    <div style="padding: 1%; height:20px; vertical-align:middle; width:50%; text-align: center;" align="center">
