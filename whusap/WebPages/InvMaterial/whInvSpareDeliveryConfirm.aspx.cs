...
namespace whusap.WebPages.InvMaterial
{
    public partial class whInvSpareDeliveryConfirm : System.Web.UI.Page
    {
        ...
        public static string Recordswassavedsuccesfully = mensajes("Recordswassavedsuccesfully");
        ...
        protected static string mensajes(string tipoMensaje)
        {
            ...
            var retorno = mensajesForm.readStatement("whInvSpareDeliveryConfirm.aspx", idioma, ref tipoMensaje);
