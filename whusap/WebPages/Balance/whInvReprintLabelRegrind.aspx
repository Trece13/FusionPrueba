...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="center" id="divTabla" runat="server" style="width:80%" >
        ...
        <div style="padding: 1%; height:20px; vertical-align:middle; width:80%; text-align: center;" align="center">
            <asp:Label ID="lblError" runat="server" Text="" CssClass="lblMessage" Width="80%" Height="20px" Visible="false" ></asp:Label>
        </div>
        <div style="padding: 1%; height:35px; vertical-align:middle; width:80%; text-align: center;" align="center">
            <asp:Button ID="btnSend" runat="server" Text="Continue" CssClass="ButtonsSendSave" Width="107px" Height="24px" onclick="btnSend_Click" TabIndex="6" /> 
            <span style="vertical-align:middle" />
        </div>
    </div>
