...
<%
	strSQL = "insert into baan.ttccol301" & Session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'RePrint Label Regrind',0,0)"
    ...
    function CheckLengthseq() {
        ...
        if (strp.match(re)) {
            if (document.getElementById("seq").value != "") {
                if (document.getElementById("seq").value.length < 3 || document.getElementById("seq").value.length > 3) {
                    alert("Please use this format Sequence, remember only 3 characters")
...
<body bgcolor="#87CEEB" onload="setFocus()">
    <form id="frminq"  method="post" action="whInvReprintLabelRegrind2.aspx">
<table>
<tr>
<td><IMG SRC = "images/logophoenix_s.jpg" ></td>
<td></td><td><H2>Reprint Labels Regrind</H2>
    </td>
</TABLE>
...
<tr> 
     <td class="titulog2" colspan="2"><b>Weight</b></td>
     <td class="style2"><input type="text" id="weight" name="weight" size="9" style="width: 131px; height: 23px;" value='<%=strseq%>'></td>
</tr>
<tr> 
