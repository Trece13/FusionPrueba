...
<%
	strSQL = "insert into baan.ttccol301" & session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'Material Disposition Warehouse',0,0)"
...
<%
Dim stritem, strwarehouse, strlocation, strlot, strlen, strware, strqty, strflag, strmsg  
...
<form name="frmord" method="post" action="whInvLabelMaterialRejectedDPrint.aspx">
<TABLE style="width: 35%">
<tr>
<td><IMG SRC = "images/logophoenix_s.jpg" ></td>
<td></td><td><H3>Material Diposition Inside MRB Warehouse - Reprint</H3>
    </td>
</TABLE>
...
<td class="style2"><input type="text" id="ware" name="ware" size="9" style="width: 131px; height: 23px;" value="<%=strware%>"></td>
</tr>
<tr> 
<td class="style2"><b>Quantity</b></td>
<td class="style2"><input type="text" id="qty" name="qty" size="9" style="width: 131px; height: 23px;" value="<%=strqty%>"></td>
</tr>
<tr> 
