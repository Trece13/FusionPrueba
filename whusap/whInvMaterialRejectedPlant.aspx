...
<%
	strSQL = "insert into baan.ttccol301" & session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'Material Rejected Plant',0,0)"
...
function CheckLength() {
    ...
    if (document.getElementById("orden").value != "") {
        if (document.getElementById("orden").value.length < 13 || document.getElementById("orden").value.length > 13) {
            alert("Remember 13 characters")
            document.getElementById("orden").focus();
...
<form name="frmord" method="post" action="whInvMaterialRejectedPlant2.aspx">
<TABLE style="width: 35%">
<tr>
<td><IMG SRC = "images/logophoenix_s.jpg" ></td>
<td></td><td><H3>Material Rejected by Plant</H3>
    </td>
</TABLE>
...
<tr> 
     <td class="style2"><b>Work Order - Secuence </b></td>
     <td class="style2">
