...
" col100.t$seqn secu, sfc010.t$mcno maquina, mcs005.t$dsca descr from baan.tticol100" & session("env") & " col100 " & _
...
<tr>
    <td colspan="2" style="font-size: x-small; color: #000000" align="center" 
        class="style1">DEFECTIVE MATERIAL TAG</td>
    <td style="font-size: x-small; color: #000000;" align="center" class="style1">DMT NUMBER</td>
</tr>
<tr>  
    <td colspan="2" style="font-size: x-small; color: #000000;" align="center" 
        class="style1">[ ] IN HOUSE REJECTION</td>
    <td style="font-size: x-small; color: #000000;" align="center" class="style1"><%=strord%>-0-<%=strsec%></td> 
</tr>
<tr>  
...
<tr>  
    <td style="font-size: small; color: #000000;" align="center" class="style18"><%=strmaquina%></td> 
    <td style="font-size: x-small; color: #000000;" align="center" class="style19"><%=stritem%></td> 
    <td style="font-size: small; color: #000000;" align="center" class="style20"><%=strqty%></td> 
</tr>
<tr>  
    <td style="font-size: small; color: #000000;" align="center" class="style17">Workorder</td>
    <td style="font-size: small; color: #000000;" align="center" class="style14">Product Description</td> 
...
<tr>  
    ...
    <td style="font-size: small; color: #000000;" align="center" class="style1">Reason</td> 
    <td style="font-size: small; color: #000000;" align="center" class="style1"><%=strdescr%></td> 
</tr>
<tr>  
    <td style="font-size: x-small; color: #000000;" align="center" class="style1"><%=session("user")%></td> 
    <td colspan="2" rowspan="2" style="font-size: x-small; color: #000000;"><%=strobse%></td>
</tr>
...
<tr>
    ...
    <td><a href="whInvItemRejected.aspx"><img src="images/btn_Exit.jpg"/></a></td>
</tr>
</table>
</div>
</body>
