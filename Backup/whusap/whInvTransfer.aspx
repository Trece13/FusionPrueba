...
<%
	strSQL = "insert into baan.ttccol301" & session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'Pet Material Rejected',0,0)"
...
<%
Dim strorden, stritem, strcant, strlen, strflag, strmsg  
...
<form name="frmord" method="post" action="whInvupdatePetMaterialRejected.aspx">
<TABLE style="width: 35%">
<tr>
<td><IMG SRC = "images/logophoenix_s.jpg" ></td>
<td></td><td><H3>Non Motan Material Request</H3>
    </td>
</TABLE>
