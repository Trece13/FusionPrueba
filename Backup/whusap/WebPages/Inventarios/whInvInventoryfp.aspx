        ...
        <table style="width: 100%">
            <tr>
                <td class="style7" style="width: 90px">
                    <span class="style2" style="vertical-align: middle; width: 70px;"><b style="font-size: 11px">
                        Warehouse</b></span>
                </td>
                <td>
        ...
        <table style="width: 100%">
            <tr>
                <td class="style8" style="width: 90px">
                    <span class="style2" style="vertical-align: middle;"><b style="font-size: 11px">Location</b></span>
                </td>
                <td>
    ...
    <div align="center" id="divItem" runat="server" style="width: 100%" visible="true">
        <table style="width: 100%">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlItem" runat="server" Width="215px" Height="20px" CssClass="DropDownList"
                        ToolTip="Select one item from list" AutoPostBack="true" OnSelectedIndexChanged="ddlItem_SelectedIndexChanged">
                    </asp:DropDownList>
                    &nbsp;&nbsp;
