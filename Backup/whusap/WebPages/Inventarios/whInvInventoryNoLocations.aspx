<%@ Page Title="" Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true"
    CodeBehind="whInvInventoryNoLocations.aspx.cs" Inherits="whusap.WebPages.Inventarios.whInvInventoryNoLocations" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Encabezado" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <div align="center" id="divTabla" runat="server" style="width: 50%">
        <table style="width: 100%">
            <tr>
                <td class="style8" style="width: 90px">
                    <span class="style2" style="vertical-align: middle;"><b style="font-size: 11px">Warehouse:</b></span>
                </td>
                <td>
                    <asp:TextBox ID="txtWarehouse" runat="server" AutoPostBack="True" OnTextChanged="txtWarehouse_TextChanged"></asp:TextBox>
                    <asp:Label ID="lblIngreso" runat="server" Text="" Visible="false"></asp:Label>
                    <asp:Label ID="lblStrUbicacion" runat="server" Text="" Visible="false"></asp:Label>
            ...
            <tr>
                <td class="style8">
                    <span class="style2" style="vertical-align: middle;"><b style="font-size: 11px">Item</b></span>
                </td>
                <td>
    ...
    <div align="center" id="divLote" runat="server" style="width: 100%" visible="true">
        <table style="width: 100%">
            <tr>
                <td class="style8" style="width: 90px">
                    <span class="style2" style="vertical-align: middle;"><b style="font-size: 11px">Lot</b></span>
                </td>
                <td>
    ...
    <div align="center" id="divCantidad" runat="server" style="width: 100%" visible="true">
        <table style="width: 100%">
            <tr>
                <td class="style8" style="width: 90px">
                    <span class="style2" style="vertical-align: middle;"><b style="font-size: 11px">Qty
                        Count:</b></span>
                </td>
                <td>
                    <div id="tooltip">
                        <span class="style2"><em>*Maximum 4 digits on decimal positions</em></span></div>
            ...
            <tr>
                <td>
                    <span class="style2" style="vertical-align: middle;"><b style="font-size: 11px">Unit:</b></span>
                </td>
                <td>
    ...
    <div style="padding: 1%; height: 20px; vertical-align: middle; width: 70%; text-align: center;"
        ...
        <br />
        <asp:Label ID="lblError" runat="server" Text="" CssClass="lblMessage" Width="80%"
    ...
    <div style="padding: 1%; height: 35px; vertical-align: middle; width: 50%; text-align: center;"
        ...
        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="ButtonsSendSave" Width="107px"
            Height="24px" TabIndex="6" Visible="false" OnClick="btnSave_Click" />
