...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div style="padding: 1%; height: 35px; vertical-align: middle; width: 50%; text-align: center;"
        align="center">
        <asp:Button ID="btnContinue" runat="server" Text="Continue" CssClass="ButtonsSendSave"
            Width="107px" Height="24px" TabIndex="6" Visible="false" OnClick="btnContinue_Click" />
        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="ButtonsSendSave" Width="107px"
            Height="24px" TabIndex="7" Visible="false" OnClick="btnSave_Click" />
