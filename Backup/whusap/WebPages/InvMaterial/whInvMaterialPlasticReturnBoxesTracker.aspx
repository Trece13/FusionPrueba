...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <table runat="server"> 
        ...
        <tbody id="tBody">
            <tr id="tCover">
                <td>
                    <asp:label ID="lblCover" runat="server"><b>Covers:</b></asp:label>
                </td>
                <td>
            ...
            <tr id="tMaster1">
                <td>
                    <asp:label ID="lblMaster1" runat="server"><b>Master 1:</b></asp:label>
                </td>
                <td>
            ...
            <tr id="tMaster2">
                <td>
                    <asp:label ID="lblMaster2" runat="server"><b>Master 2:</b></asp:label>
                </td>
                <td>
			...
			<tr id="tMaster3">
                <td>
                    <asp:label ID="lblMaster3" runat="server"><b>Master 3:</b></asp:label>
                </td>
                <td>
            ...
            <tr id="tBox">
                <td>
                    <asp:label ID="lblBox" runat="server"><b>Boxes:</b></asp:label>
                </td>
                <td>
