    ...
    public partial class whInvSpareDelivery : System.Web.UI.Page
    {
        ...
        protected void grdRecords_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //((TextBox)e.Row.Cells[6].FindControl("toReturn")).
                //                         Attributes.Add("onblur", "if(this.value != '') { validateMov('this.value, this);}");
        ...
        protected void btnContinue_Click(object sender, EventArgs e)
        {
            ...
            SetRowData();
            lblResult.Text = "Please review all item's before save";
        }
        ...
        protected void grdRecords_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                lblResult.Text = "ViewState is null. Please contact to support";
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (ViewState["tablaTemp"] != null)
            {
                ...
                if (tablaTemp.Rows.Count >= 1)
                {
                    ...
                    lblResult.Text = "Spare Delivery was succesfully registered.";
        ...
        protected bool verifyRow()
        {
            ...
            {
                lblResult.Text = "Item can't be empty. Cannot Continue";
            ...
            {
                lblResult.Text = "Location can't be empty. Cannot Continue";
            ...
            {
                lblResult.Text = "Location don't have warehouse associated. Cannot Continue";
                return false;
            }
            if (Convert.ToDecimal(txttoReturn.Text) < 1)
            {
                lblResult.Text = "Quantity must be greather than zero. Cannot Continue";
                txttoReturn.Text = "0";
                txttoReturn.Focus();
