  ...
  //      string Aplicacion = "WEBAPP";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string strTitulo = "Physical Inventory";
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            {
                lblError.Text = "Lot Code is empty, enter Lot Code";
                txtLote.Focus();
                return;
            }
        ...
        public static string validaInfo(string valor, string tipo)
        {
            ...
            if (tipo == "2") // Zona
            {
                ...
                if (resultado.Rows.Count > 0)
                {
                    ...
                    if (consecutivo < 1) { strError = "Sequence Zone " + valor + " doesn't exist. Cannot Continue"; }
                }
            }
            if (tipo == "3") // Item
            {
