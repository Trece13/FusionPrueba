<%@ Page Title="" Language="C#" MasterPageFile="~/MDMasterPage.Master" AutoEventWireup="true"
    CodeBehind="whInvConfirmedRegrind.aspx.cs" Inherits="whusap.WebPages.Balance.whInvConfirmedRegrind" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="center" id="divTabla" runat="server" style="width: 80%">
            ...
            <tr>
                <td>
                    <span style="vertical-align: middle" /><span class="style2" style="vertical-align: middle;">
                        <b style="font-size: 11px">Regrind Sequence</b></span>
                </td>
                <td style="width: 120px">
                    <span style="vertical-align: middle;">
        ...
        <div style="padding: 1%; height: 35px; vertical-align: middle; width: 50%; text-align: center;"
            align="center">
            <asp:Button ID="btnQuery" runat="server" Text="Query" CssClass="ButtonsSendSave"
                Width="107px" Height="24px" OnClick="btnQuery_Click" TabIndex="6" />
            <span style="vertical-align: middle" />
        </div>
        ...
        <div id="printerDiv" runat="server" style="color: Red;">
            ...
            <table style="width: 60%" border="1px">
                ...
                <tr>
                    <td class="style8">
                        <span class="style2" style="vertical-align: middle;"><b style="font-size: 11px">Work
                            Order </b></span>
                    </td>
                    <td style="width: 80%">
                ...
                <tr>
                    <td>
                        <span style="vertical-align: middle" /><span class="style2" style="vertical-align: middle;">
                            <b style="font-size: 11px">Regrind Code</b></span>
                    </td>
                    <td style="width: 120px">
                ...
                <tr>
                    <td>
                        <span style="vertical-align: middle" /><span class="style2" style="vertical-align: middle;">
                            <b style="font-size: 11px">Quantity to confirm</b></span>
                    </td>
                    <td style="width: 120px">
