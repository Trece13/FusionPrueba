...
<%
	strSQL = "insert into baan.ttccol301" & Session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'Inventory Raw Material',0,0)"
...
<%
Dim stralmubic, stralmacen, strubicacion, strlote, stritem, strlen, strflag, strmsg, strmsg1
...
<td><H3>Inventory Raw Material</H3></td>
</TABLE>
...
<tr> 
     ...
     <td class="style2""><input type="text" id="txtalmubic" name="txtalmubic" size="10" onchange="FocusLot();" value='<%=stralmubic%>'></td>
</tr> 
<tr> 
	 <td class="style2"><b>Lot:</b></td>
	 <td class="style2"><input type="text" id="txtlote" name="txtlote" size="10" onchange="FocusItem();" value='<%=strlote%>'></td>
</tr> 
<tr> 
