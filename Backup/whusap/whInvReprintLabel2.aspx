...
Dim strmsg, strflag, strmachine, struser, sec, sec1, weight
...
strSQL = "select col022.t$pdno orden, col022.t$sqnb secuence, col022.t$qtdl weight, col022.t$date-5/24 fecha, col022.t$mitm item, ibd001.t$dsca desci, " & _
...
If Not objrs.EOF Then
    ...
    if strdel = 1 then
	    ...
	    Response.Redirect("whInvReprintLabel.aspx?flag=")         
    end if
...
<tr>
    <td colspan="3" style="font-size: medium; color: #000000; font-family: Arial; width: 4.8in;" align="center" ><%=strdesci%></td>
</tr>
<tr>
    <td colspan="3">
...
<tr>  
    ...
    <td style="font-size: medium; color: #000000;" align="center">Weight</td>  
    <td style="font-size: medium; color: #000000;" align="center">Roll Number</td> 
</tr>
<tr>  
    <td style="font-size: medium; color: #000000;" align="center"><%=strord%></td> 
    <td style="font-size: medium; color: #000000;" align="center"><%=weight%></td>  
    <td style="font-size: medium; color: #000000;" align="center"><%=sec1%></td> 
</tr>
<tr>     
...
<tr>  
    ...
    <td style="font-size: medium; color: #000000;" align="center">R - L</td>  
    <td style="font-size: medium; color: #000000;" align="center">Machine</td>  
</tr>
<tr>  
    <td style="font-size: medium; color: #000000;" align="left" colspan="2">Reprinted by <%=session("user")%></td> 
    <td style="font-size: medium; color: #000000;" align="center"><%=strmaq%>    
    </td>  
</tr>
<!-- #include file="include/dbxconoff.inc" -->
<%
Else
    Session("strmsg") = "Order and sequence doesn't be created or was delete, Print roll pallet tag first1111."
	Response.Redirect("whInvReprintLabel.aspx?flag=") 
End if
%>
</table>
...
<td><a href="whInvReprintLabel.aspx"><img src="images/btn_Exit.jpg"></a>
</td>
</tr>
</table>
</div>
