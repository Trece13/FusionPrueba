...
<%
	strSQL = "insert into baan.ttccol301" & Session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'Inventory Finish Product',0,0)"
...
<form name="frmord" method="post" action="whInvInventoryfp2.aspx">
