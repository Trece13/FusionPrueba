...
<tr>
	...
	<% end if %>
    <% if InStr(Session("opciones"),"BOXESP")<>0 then %>
	    <td align="center"><a href="whInvBoxesProduced.aspx"><img src="Images/btn_boxesprod.jpg"></a></td>
	<% end if %>
</tr> 
<tr> 
...
<tr>
    <% If InStr(Session("opciones"), "LABELD") <> 0 Then%>
	    <td align="center"><a href="whInvLabelDmt.aspx"><img src="Images/btn_printdmt.jpg"></a></td>
	<% end if %>
