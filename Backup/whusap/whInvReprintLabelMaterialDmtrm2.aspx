...
Dim strmsg, strflag, strqty, strart, strreason, strcant, strpos, strlot, strobse, strdescr
...
" col100.t$seqn secu, sfc010.t$mcno maquina, mcs005.t$dsca descr, col100.t$date fecha, col100.t$clot lot, col100.t$obse obse from baan.tticol100" & session("env") & " col100 " & _
...
" inner join baan.ttisfc010" & session("env") & " sfc010 on sfc010.t$pdno = col100.t$pdno and sfc010.t$opno = 10 " & _
...
<tr>  
    <td colspan="2" style="font-size: small; color: #000000;" align="center" class="style1">[ ] PURCHASED MATERIAL</td>
    <td style="font-size: small; color: #000000;" align="center" class="style10"><%=strord%>-<%=strpos%>-<%=strsec%></td> 
</tr>
<tr>  
    <td colspan="2" style="font-size: small; color: #000000;" align="center" class="style1">Product Code</td>  
    <td style="font-size: small; color: #000000;" align="center" class="style10">Total Qty Rejected</td> 
</tr>
<tr>  
    <td colspan="2" style="font-size: small; color: #000000;" align="center" class="style1"><%=stritem%></td> 
    <td style="font-size: small; color: #000000;" align="center" class="style10"><%=strqty%></td> 
</tr>
<tr>  
    <td colspan="2" style="font-size: small; color: #000000;" align="center" class="style1">Product Description</td> 
    <td style="font-size: small; color: #000000;" align="center" class="style1">Date</td> 
</tr>
<tr>
    <td colspan="2" style="font-size: small; color: #000000;" align="center" class="style2"><%=strdesci%></td>  
...
<tr>  
    ...
    <td style="font-size: small; color: #000000;" align="center" class="style1">Internal Mat Lot</td> 
</tr>
<tr>  
    <td style="font-size: small; color: #000000;" align="center" class="style1"><%=session("user")%></td> 
    <td style="font-size: small; color: #000000;" align="center" class="style1"><%=strord%></td>
    <td style="font-size: small; color: #000000;" align="center" class="style1"><%=strlot%></td>
</tr>
<tr> 
    <td colspan="1" style="font-size: small; color: #000000;" align="center" class="style1">Reason</td>
    <td colspan="2" style="font-size: small; color: #000000;" align="center" class="style1"><%=strdescr%></td>
</tr>
<tr> 
    <td colspan="3" style="font-size: small; color: #000000;" align="center" class="style1"><%=strobse%></td>
</tr>
</table>
...
Else
    ...
    " col101.t$seqn secu, sfc010.t$mcno maquina, mcs005.t$dsca descr, col101.t$date fecha, col101.t$clot lot, col101.t$obse obse from baan.tticol101" & session("env") & " col101 " & _
    ...
    " inner join baan.ttisfc010" & session("env") & " sfc010 on sfc010.t$pdno = col101.t$pdno and sfc010.t$opno = 10 " & _
...
<tr>
    <td colspan="2" style="font-size: small; color: #000000;" align="center" class="style2"><%=strdesci%></td>  
    <td style="font-size: small; color: #000000;" align="center" class="style1">
    <asp:Label ID="Label1" runat="server" Text="Date" Font-Bold="True" Font-Names="Arial" Font-Size="small" ForeColor="Black"></asp:Label></td>
</tr>
<tr>  
    <td style="font-size: small; color: #000000;" align="center" class="style1">Printed By</td> 
    <td style="font-size: small; color: #000000;" align="center" class="style1">WorkOrder</td> 
...
<%
    Else
        Session("strmsg") = "Order doesn't register raw materail to MRB."
	    Response.Redirect("whInvReprintLabelDmtrm.aspx?flag=") 
    End if
End if
%>
</table>
...
<tr>
    ...
    <td><a href="whInvReprintLabelDmtrm.aspx"><img src="images/btn_Exit.jpg"/></a></td>
</tr>
</table>
</div>
</body>
