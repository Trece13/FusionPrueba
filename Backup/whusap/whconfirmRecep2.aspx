...
Dim objrs, Odbcon, strmsg, strflag, stralm, strdesal, strsts, strtotqty,strtotqtyent,strqtypend, strqtyplt, stranun
...
<%
	...
	" t$qdlv+(select nvl(sum(T$QTDL),0) from baan.tticol025" & Session("env") & " where T$PDNO=o.t$pdno and T$MITM=o.t$mitm) TotqtyEnt, f.t$conv Qtyplt  " & _
