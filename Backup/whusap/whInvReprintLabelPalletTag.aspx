...
<%
	strSQL = "insert into baan.ttccol301" & Session("env") & " (t$user,t$fein,t$come,t$refcntd,t$refcntu) values('" & Session("user") & "',sysdate+5/24,'RePrint Label Pallet Tags',0,0)"
...
<body bgcolor="#87CEEB" onload="setFocus()">
    <form id="frminq"  method="post" action="whInvReprintLabelPalletTag2.aspx">
<table>
<tr>
<td><IMG SRC = "images/logophoenix_s.jpg" ></td>
<td></td><td><H2>Reprint Pallet Tags</H2>
    </td>
</TABLE>
